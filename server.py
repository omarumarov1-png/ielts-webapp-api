...
Оценивай мягче реального экзамена — на 1–1.5 балла выше строгой шкалы IELTS. Среднее эссе — 6.5–7.0. Не занижай балл за мелкие недочёты, фокусируйся на поддержке и позитивной обратной связи, но сохраняй честность в разделе "УЛУЧШИТЬ"."""
